...
// import './Login.css';
// import bgimg from '../Image/bg-img.png';
// import bgimg from '../Image/bg-img1.png';
...
//                     <img src={bgimg} className='img-fluid'></img>
//                 </div>
//                 <div className='login-form position-absolute'>
//                     <div className='login-logo'>
//                         <img src={logoLogin} className='img-fluid' style={{ width: "100px" }} alt="Logo" />
//                     </div>
